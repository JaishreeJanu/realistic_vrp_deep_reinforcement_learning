...
from data.BufferManager import ReplayBuffer, ReplayBufferManager, VectorReplayBuffer
...
class Collector(object):
    ...
    def collect(
        ...
        while True:
            #print(len(self.data), len(ready_env_ids))
            ...
            # step in env
            result = self.env.step(self.data.act, ready_env_ids)  # type: ignore
            ...
            if (n_step and step_count >= n_step) or \
                ...
                print("Entered break loop!", n_episode, episode_count)
                break
